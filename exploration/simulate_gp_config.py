...
simple_kernel_config = {
    ...
    "sin_day": {"kernel": ExpSineSquared, "params": {
        "length_scale": 3, "periodicity": PERIOD_DAY}, "bound_params": {}, "scale": 10},
    "sin_week": {"kernel": ExpSineSquared, "params": {
               "length_scale": 3, "periodicity": PERIOD_WEEK}, "bound_params": {}, "scale": 5},
...
_kernels = {"sinrbf": _simple_kernels_fixed["sin_day"] * _simple_kernels_fixed["rbf_long"], **_simple_kernels}
