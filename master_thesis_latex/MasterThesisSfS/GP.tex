...
to find the optimal model structure. In Gaussain process regression
this can be viewed as finding the optimal kernel function type, which is often not done
through evaluation of the posterior but through cross validation after having found
the optimal set of hyperparameters $\theta$ for all the candidate kernels.
