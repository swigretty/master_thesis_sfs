...
The most common approaches are Bayesian model selection and estimation of the
generalization error using cross validation.

A suitable loss function to be used for cross validation is based on the performance metric
defined in section
\ref{sec:performance-assessment}.
The rest of this section is dedicated to bayesian model selection, which is probably less known.

\subsection{Bayesian Model Selection}
Bayesian model selection looks for the most probable model given the data and some prior believe on the data
generating process. A hierarchical specification of the model will help to understand at what level
inference can occur.
