...
shifted to contain only positive values
...
The values of the periodic component (orange) is shifted to contain only postivive values and
is used as probablity weights in seasonal sampling.
Squared values are used in the case of extreme seasonal sampling}
