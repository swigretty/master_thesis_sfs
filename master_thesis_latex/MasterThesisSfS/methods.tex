...
and similarly for other estimated quantities.
...
From $\hat{k}(x,x')$ the predictive distribution over $F_X$ is calculated
...
\begin{algorithm}[h!] \caption{Simulation and Evaluation Flow}
 ...
 \hspace*{\algorithmicindent} TargetFunction \algorithmiccomment{Functino to extracts target measures from $F_X$ and $\hat{F}_X$} \\
