...
First $X_{train}$ and $X$ were transformed to cubic B-splines using
the sklearn.preprocessing.SplineTransformer class.
...
and the optimal number has been identified through 10-fild
cross validation.
...
\lstset{frame=lines}
\lstset{caption={Fit smooting spline and predict $F_X$}}
...
\end{lstlisting}\label{code:smoothing-spline}
...
\begin{subfigure}{.45\textwidth}
    \centering
    \includegraphics[width=0.6\linewidth]{Pictures/plots_final/sin_rbf_default_0.2/09_06_09_09_17/plot_posterior_linear}
    \caption{Linear Regression}
    \label{fig:post-linear}
\end{subfigure}\hfill
\begin{subfigure}{.45\textwidth}
    \centering
    \includegraphics[width=0.6\linewidth]{Pictures/plots_final/sin_rbf_default_0.2/09_06_09_09_17/plot_posterior_spline}
    \caption{Smoothing Spline}
    \label{fig:post-spline}
\end{subfigure}
\caption{The estimated BP values $\hat{F}_X$ (black line) and the
