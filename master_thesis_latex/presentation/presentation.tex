...
\begin{frame}
	\frametitle{Methods - GP Regression}
	\framesubtitle{Example Uniform Sampling 1}

	\begin{figure}
			\includegraphics[width=0.6\linewidth]{new_measurement_transform_quantile_sin_rbf_default_08_19_14_50_32_fit}
			\caption{GP fitted to 1 week BP time series with 2 samples per hour (uniformly sampled across time)}
	\end{figure}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item TTR Naive: Mean of available measurements within the time period. If no available measurement
			global mean is used
		\end{itemize}
	\end{itemize}
