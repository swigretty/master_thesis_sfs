...
\begin{frame}[fragile]
	...
	\framesubtitle{Aktiia Population Level Time Series Characteristics}
...
\begin{frame}
	...
	\begin{itemize}
		\item cyclic pattern amplitude $\approx 8 mmHg$
				\begin{figure}
					\includegraphics[width=0.5\linewidth]{20230531_LinTrap_amplitude_distrib}
...
\begin{frame}
	...
	\begin{figure}
			\includegraphics[width=0.6\linewidth]{new_measurement_transform_quantile_sin_rbf_default_08_19_14_50_32_fit}
...
\begin{frame}
	\frametitle{Methods - Performance Evaluation}
	\framesubtitle{Simulation and Evaluation}
...
\begin{frame}
	...
	\framesubtitle{Overall mean}
		...
		\begin{figure}
			\includegraphics[width=0.6\linewidth]{new_measures_transform_qunatile_sin_rbf_default_08_19_14_50_32_plot_posterior_naive_overall_mean}
...
\begin{frame}
	...
	\framesubtitle{Linear Regression}
		\begin{figure}
			\includegraphics[width=0.6\linewidth]{new_measures_transform_qunatile_sin_rbf_default_08_19_14_50_32_plot_posterior_linear}
			\caption{1 week BP time series with 2 samples per hour (uniformly sampleed across time)}
		\end{figure}
...
\begin{frame}
	...
	\framesubtitle{Spline}
		\begin{figure}
			\includegraphics[width=0.6\linewidth]{new_measures_transform_qunatile_sin_rbf_default_08_19_14_50_32_plot_posterior_spline}
			\caption{1 week BP time series with 2 samples per hour (uniformly sampleed across time)}
		\end{figure}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Cubic Spline:
			\begin{itemize}
				\item smooting parameter identified by cross validation
			\end{itemize}
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		\begin{column}{0.45\textwidth} % Left column width
				\begin{figure}
					\includegraphics[width=\linewidth]{new_measurement_transform_quantile_sin_rbf_default_08_14_50_32_plot_posterior_gp.png}
					\caption{GP}
		...
		\begin{column}{0.5\textwidth} % Right column width
				\begin{figure}
					\includegraphics[width=\linewidth]{new_measures_transform_qunatile_sin_rbf_default_08_19_14_50_32_plot_posterior_linear.pdf}
